...
## Project Structure
    ...
    ├── testapiautosetting_115464  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_115464`
...
2. Clone this repo and `cd testapiautosetting_115464`
